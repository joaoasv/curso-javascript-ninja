(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'João Pedro'));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/, function(match, group) {
    ...
    */
    ...
    var newDate = text.replace(regexDate, function replaceDate(regex, day, month, year) {
