(function () {
    ...
    */
    ...
    const openHtml = `<div><ul><li></li><li></li><li><span></span></li></ul></div>`;
    console.log(openHtml.match(/<\w+><\/\w+>/g));
    ...
    */
    ...
    console.log(markup.replace(rgx, '$1 O texto dentro da tag "$1" é "$2" $3\n'));
