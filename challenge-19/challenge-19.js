(function () {
    ...
    */
    ...
    console.log(otherText.match(pattern));
    ...
    */
    ...
    function hasClass(markup, cssClass) {
        const pattern = new RegExp(`class=["'](?:[\\w+\\s]+)?(${cssClass})[\\s]?["']?`);
        return console.log(`${pattern.test(markup)} para a classe ${cssClass}`);
    }
