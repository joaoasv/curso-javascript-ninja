(function(window, document) {
    ...
    */
    const username = prompt(`what's your name, bb ?`) || 'Desconhecido';
    ...
    */
    ...
    const email = prompt(`what's your email, ${username}?`);
    ...
    */
    ...
    $button.addEventListener('click', (event) => {
        ...
        if(!isValidEmail($inputEmail.value))
            return alert(`Entre com um formato de e-mail válido!`);

        if(!confirm(`Tem certeza que deseja enviar a mensagem?`))
            return alert(`Não enviado, usuário cancelou o envio.`);
